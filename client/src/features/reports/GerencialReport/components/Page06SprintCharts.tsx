          ...
          <table className={`w-full text-left border-collapse `}>
            <thead>
              <tr className={"bg-[#1a237e] text-white text-[9px] uppercase font-bold"}>
                <th className={`p-2 px-4 w-12 text-center border-r border-white/10`}>ID</th>
                <th className={`p-2 px-4 border-r border-white/10`}>Tarefa</th>
                <th className={`p-2 px-4 border-r border-white/10`}>Categoria</th>
                <th className={`p-2 px-4 border-r border-white/10`}>Épico</th>
