...
export const Page01Cover: React.FC<Props> = ({ data }) => {
  return (
    <div className="w-full h-full flex flex-col justify-between p-16 relative overflow-hidden print:p-2 print:break-after-page">
      ...
      <div className="space-y-4">
        ...
        <h1 className="text-7xl font-black leading-tight max-w-4xl text-[#1a237e] print:text-2xl">
          {data.title}
        </h1>
      </div>
      ...
      <div className="space-y-8">
        <div className="space-y-2">
          <p className="text-2xl font-bold text-[#283593] print:text-xl">{data.organization}</p>
          <p className="text-xl font-medium text-gray-500 print:text-sm">
