...
function applyTemplate(input, ticket) {
    return input
...
export const runAutomations = async (trigger, ticket) => {
        ...
        for (const cond of rule.conditions) {
            ...
            switch (cond.operator) {
                ...
                case "not_equals":
                    ...
                    break;
                case "contains":
                    if (!String(ticketValue).includes(String(ruleValue)))
                        match = false;
                    break;
                case "greater_than":
                    if (Number(ticketValue) <= Number(ruleValue))
                        match = false;
                    break;
                default:
                    match = false;
...
async function executeActions(actions, ticket) {
